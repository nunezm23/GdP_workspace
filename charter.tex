...
\fechaFINALTrabajo{13 de diciembre de 2026}	%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en el desarrollo de un prototipo funcional de sistema embebido para la adquisición, registro y monitoreo de señales analógicas en entornos industriales. El trabajo tendrá un presupuesto preliminar estimado de {600} horas y un costo estimado de {\$ 2500}, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
